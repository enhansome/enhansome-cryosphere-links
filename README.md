...
* [xDEM](https://github.com/GlacioHack/xdem) ⭐ 218 | 🐛 139 | 🌐 Python | 📅 2026-09-18 - A Python module developed by glaciologists for handling DEMs: read/write, coregistration, volume change calculation etc.
...
* [Elmer/Ice](https://github.com/elmercsc/elmerfem) ⭐ 1,706 | 🐛 81 | 🌐 Fortran | 📅 2026-09-18 - Open Source Finite Element Software for Ice Sheet, Glaciers and Ice Flow Modelling
...
* [Úa](https://github.com/GHilmarG/UaSource) ⭐ 25 | 🐛 0 | 🌐 MATLAB | 📅 2026-09-18 - A large-scale ice-flow model
...
* [icepyx](https://github.com/icesat2py/icepyx) ⭐ 259 | 🐛 113 | 🌐 Python | 📅 2026-09-14 - Python tools for obtaining and working with ICESat-2 laser altimetry data
