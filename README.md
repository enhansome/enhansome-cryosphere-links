...
* [xDEM](https://github.com/GlacioHack/xdem) ⭐ 215 | 🐛 151 | 🌐 Python | 📅 2026-08-31 - A Python module developed by glaciologists for handling DEMs: read/write, coregistration, volume change calculation etc.
...
* [Elmer/Ice](https://github.com/elmercsc/elmerfem) ⭐ 1,696 | 🐛 84 | 🌐 Fortran | 📅 2026-09-07 - Open Source Finite Element Software for Ice Sheet, Glaciers and Ice Flow Modelling
...
* [Úa](https://github.com/GHilmarG/UaSource) ⭐ 25 | 🐛 0 | 🌐 MATLAB | 📅 2026-09-06 - A large-scale ice-flow model
