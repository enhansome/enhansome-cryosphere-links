...
* [xDEM](https://github.com/GlacioHack/xdem) ⭐ 215 | 🐛 156 | 🌐 Python | 📅 2026-08-22 - A Python module developed by glaciologists for handling DEMs: read/write, coregistration, volume change calculation etc.
...
* [Elmer/Ice](https://github.com/elmercsc/elmerfem) ⭐ 1,672 | 🐛 74 | 🌐 Fortran | 📅 2026-08-22 - Open Source Finite Element Software for Ice Sheet, Glaciers and Ice Flow Modelling
...
* [Úa](https://github.com/GHilmarG/UaSource) ⭐ 25 | 🐛 0 | 🌐 MATLAB | 📅 2026-08-22 - A large-scale ice-flow model
...
* [icepyx](https://github.com/icesat2py/icepyx) ⭐ 257 | 🐛 113 | 🌐 Python | 📅 2026-08-17 - Python tools for obtaining and working with ICESat-2 laser altimetry data
...
* [Glacier & Ice Sheet Dynamics at Georgia Tech](https://github.com/nsidc/NSIDC-Data-Tutorials) ⭐ 104 | 🐛 17 | 🌐 Jupyter Notebook | 📅 2026-08-17 - Alex Robel's slides, notes, and code demonstrations for grad/undergrad course in glaciology
