...
* [xDEM](https://github.com/GlacioHack/xdem) ⭐ 215 | 🐛 146 | 🌐 Python | 📅 2026-09-09 - A Python module developed by glaciologists for handling DEMs: read/write, coregistration, volume change calculation etc.
...
* [Elmer/Ice](https://github.com/elmercsc/elmerfem) ⭐ 1,700 | 🐛 81 | 🌐 Fortran | 📅 2026-09-09 - Open Source Finite Element Software for Ice Sheet, Glaciers and Ice Flow Modelling
...
* [Úa](https://github.com/GHilmarG/UaSource) ⭐ 25 | 🐛 0 | 🌐 MATLAB | 📅 2026-09-09 - A large-scale ice-flow model
